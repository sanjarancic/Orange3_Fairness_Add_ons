...
NAME = "Orange3 Fairness Add-ons"

VERSION = "0.0.1"

AUTHOR = 'Sanja'
AUTHOR_EMAIL = 'sr20170133@student.fon.bg.ac.rs'

# URL = 'http://orange.biolab.si/download'
DESCRIPTION = "Add-on containing fairness widgets"
